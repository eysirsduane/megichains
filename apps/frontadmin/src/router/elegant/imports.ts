...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  address_group: () => import("@/views/address/group/index.vue"),
  address_list: () => import("@/views/address/list/index.vue"),
  ...
  fund_collectlog: () => import("@/views/fund/collectlog/index.vue"),
  fund_collectlogdetail: () => import("@/views/fund/collectlogdetail/index.vue"),
  fund_list: () => import("@/views/fund/list/index.vue"),
  fund_statistics: () => import("@/views/fund/statistics/index.vue"),
