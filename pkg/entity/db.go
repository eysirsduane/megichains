...
func NewGormDB(cfg *global.BackendesConfig) (db *gorm.DB, err error) {
	...
	err = db.AutoMigrate(&RangeConfig{}, &User{}, &Merchant{}, &MerchOrder{}, &Address{}, &AddressGroup{}, &AddressBalance{}, &AddressFundCollect{}, &AddressFundCollectLog{}, &EvmLog{}, &TronTransaction{}, &SolanaTransaction{})
	if err != nil {
		panic(err)
	}
