...
const { columns, columnChecks, data, getData, getDataByPage, loading, mobilePagination } = useUIPaginatedTable({
  ...
  columns: () => [
    ...
    { prop: 'merch_order_id', label: $t('page.order.common.merch_order_id') },
    { prop: 'chain', label: $t('page.order.common.chain') },
    { prop: 'currency', label: $t('page.order.common.currency') },
    {
      prop: 'typo',
    ...
    { prop: 'received_amount', label: $t('page.order.common.received_amount') },
    { prop: 'received_sun', label: $t('page.order.common.received_sun'), width: 180 },
    { prop: 'from_address', label: $t('page.order.common.from_address'), width: 320 },
    { prop: 'to_address', label: $t('page.order.common.to_address'), width: 320 },
