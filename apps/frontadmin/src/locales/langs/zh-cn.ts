const local: App.I18n.Schema = {
  ...
  page: {
    ...
    about: {
      title: '关于',
      introduction: `megichains 是一个优雅且功能强大的Tron链数据资源后台管理模板，基于最新的前端技术栈，包括 Vue3, Vite5, TypeScript, Pinia 和 UnoCSS。`,
      projectInfo: {
        title: '项目信息',
        version: '版本',
    ...
    transaction: {
      ...
      delegate: {
        order: {
          ...
          received_sun: '收到金额SUN',
          delegate_amount: '待委托金额',
          delegate_sun: '待委托金额SUN',
          withdraw_time: '回收时间'
        },
        bill: {
          title: '发货明细',
          delegated_amount: '已委托金额',
          delegated_sun: '已委托金额SUN'
        },
        withdraweral: {
          title: '回收明细',
          un_delegated_amount: '已收回金额',
          un_delegated_sun: '已收回金额SUN'
        }
      },
      exchange: {
        order: {
          ...
          exchange_sun: '兑换金额SUN',
          then_rate: '当时汇率(TRX2U)',
          exchange_rate: '兑换汇率(TRX2U)',
          exchange_discount: '兑换折扣'
        },
        bill: {
          exchanged_amount: '兑换金额',
          exchanged_sun: '兑换金额SUN'
        }
      }
    }
  },
